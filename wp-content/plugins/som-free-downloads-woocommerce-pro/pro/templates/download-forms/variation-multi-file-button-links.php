<?php
/**
 * Free Downloads - WooCommerce - Multi-file button & links download template
 * 
 * 
 * @version	2.4.92
 */
...
<div class="somdn-download-wrap">
	...
	foreach( $downloads as $key => $each_download )  {
		...
		<form action="<?php echo esc_url( get_permalink( $product_id ) ); ?>" class="somdn-download-form" method="post" id="somdn-md-form-<?php echo $count; ?>">

			<?php do_action( 'somdn_before_form_inputs_variation', $product_id, $variation_id ); ?>
							 
			<div class="somdn-form-table-bottom">

				<input type="hidden" name="action" value="somdn_download_multi_single_variation">
	...
	<div style="padding-top: 15px">
		...
		<form action="" method="post" class="somdn-button-form somdn-download-form">
