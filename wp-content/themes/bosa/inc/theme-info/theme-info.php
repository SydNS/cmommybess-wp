...
$config = array(
    ...
    'quick_links' => array(
        'theme_url'  => array(
            ...
            'url' => 'https://bosathemes.com'
        ),
        'demo_url'  => array(
            'text' => __( 'View Demo', 'bosa' ),
            'url' => 'https://demo.bosathemes.com/bosa'
        ),
        'pro_url'  => array(
    ...
    'gs_steps' => array(
        ...
        'second' => array(
            ...
            'button_link' => esc_url( 'https://demo.bosathemes.com/bosa' ),
            'is_button' => true,
            'is_new_tab' => true
        ),
        'third' => array (
    ...
    'support_content' => array(
        'first' => array(
            ...
            'button_link' => esc_url( 'https://bosathemes.com/pricing' ),
            'is_button' => true,
            'is_new_tab' => true
        ),
        'second' => array (
    ...
    'free_pro' => array (
        'first'=> array(
            ...
            'desc' => esc_html__ ( 'Bosa is a multipurpose free WordPress theme. However, Bosa Pro comes with more cool and awesome features that give you a flexible and wide range of options to build a full-fledged website.', 'bosa' ),
    ...
    'demos' => array (
        'first'=> array(
            ...
            'link_url' => esc_url( 'https://demo.bosathemes.com/bosa' ),
            'is_button' => true,
            'recommended_actions' => false,
            'is_new_tab' => true
        ),
